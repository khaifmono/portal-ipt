    ...
    <div className="max-w-6xl mx-auto px-4 lg:px-8 py-8">
      ...
      {courses.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-gray-600 font-medium">Tiada kursus tersedia.</p>
          <p className="text-gray-400 text-sm mt-1">Hubungi pentadbir untuk pendaftaran kursus.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {courses.map((course, i) => (
            ...
            >
              ...
              {/* Card footer */}
              <div className="bg-white px-4 py-4 flex items-start justify-between">
