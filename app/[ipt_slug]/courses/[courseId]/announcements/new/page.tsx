  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        >
          &larr; Kembali ke {course.title}
        </Link>

        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h1 className="text-xl font-bold text-gray-900 mb-1">Tambah Pengumuman</h1>
          <p className="text-sm text-gray-500 mb-6">
            {course.title}
          </p>

          <NewAnnouncementForm iptSlug={ipt_slug} courseId={courseId} />
        </div>
      </div>
    </main>
  )
